...
SASP is complex. It contains dozens of molecules. The authors therefore use a functional screening strategy rather than guessing which factor matters most.
...
TGFβ is often associated with SMAD signaling and epithelial-mesenchymal transition. But here, the dominant effect is activation of growth and survival pathways.
...
The study does not stop at mechanism. It asks whether this knowledge can be exploited therapeutically.
...
This human validation strengthens the relevance of the mechanistic findings.

Clinical implications

This work reframes how we think about platinum resistance.

Resistance is not only a cell-intrinsic genetic problem. It may also be a microenvironmental consequence of the therapy itself.

Platinum chemotherapy can induce senescence. Senescent cells can accumulate. Their TGFβ-rich secretome can reactivate growth signaling in neighboring tumor cells through AKT and mTOR. 
